'use client'; // ✅ Faylning eng yuqori qatorida bo‘lishi kerak
...
export default function CheckoutPage() {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      // Agar siz serverga yubormoqchi bo'lsangiz, token va API chaqiruvi qo'shishingiz mumkin
      const orderData = {
